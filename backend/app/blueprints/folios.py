...
from ..services.ciclos import fecha_limite_por_periodo, generar_ciclo_mensual_empresa
...
def crear_folio():
    ...
    folio = Folio(
        ...
        fecha_limite_entrega=(
            ...
            else fecha_limite_por_periodo(body["periodo"])
        ),
...
def generar_ciclo_mensual():
    ...
    creados = generar_ciclo_mensual_empresa(empresa, periodo, body.get("usuario"))
    if not creados:
